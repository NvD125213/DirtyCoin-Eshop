...
@section('css')
    <link rel="stylesheet" href="{{asset('admin/product/edit.css')}}">
    
@endsection

@section('content')
<div class="content-wrapper">
    @include('Admins.Components.content-header', ['name' => 'slider', 'key' => 'Sửa thông tin'])
                ...
                <div class="col-md-6">
                    <form action="{{route('slider.update', ['id' => $sliders->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="name" type="text" value="{{$sliders->name}}" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tên danh mục tại đây!" required>
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <img class="product_image" src="{{$sliders->link}}" alt="">
                                @error('link')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
