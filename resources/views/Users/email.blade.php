...
<head>
    ...
    <title>Thông báo đơn hàng | DirtyCoin eCommerce</title>
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        ...
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            <b>Ngày tạo đơn hàng:</b> {{ date('d/m/yy H:i', strtotime($order->created_at)) }}
                            <br>
                            <b>Địa chỉ:</b> {{ $order->address . ' - ' .  $order->address_city }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        <p>Quý khách có thể kiểm tra hình thức bên ngoài của sản phẩm (nhãn hiệu, mẫu mã, màu sắc, số lượng,...) 
                            trước khi thanh toán và có thể từ chối nhận hàng nếu không hài lòng. Vui lòng không kích hoạt thiết bị điện-điện tử hoặc thử sản phẩm.</p>

                        <p>Nếu sản phẩm có dấu hiệu hư hỏng/hỏng hoặc không khớp với thông tin trên website, 
                            vui lòng liên hệ với cửa hàng trong vòng 48h kể từ thời điểm nhận hàng để được hỗ trợ.</p>

                        <p>Quý khách vui lòng giữ lại hóa đơn, hộp sản phẩm và phiếu bảo hành (nếu có) để đổi trả hoặc bảo hành khi cần thiết.</p>

                        <p>ạn có thể tham khảo trang Trung tâm trợ giúp hoặc liên hệ với cửa hàng bằng cách để lại tin nhắn tại
                            Trang liên hệ hoặc gửi thư tại đây. HOTLINE 1900 9999 (8h00 - 9h00 cả thứ 7 và chủ nhật).</p>

                        <b>DirtyCoin xin cảm ơn quý khách.</b>
                    </div>
                </div>
            </div>
